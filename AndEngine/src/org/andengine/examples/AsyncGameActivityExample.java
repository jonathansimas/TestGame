...
public class AsyncGameActivityExample extends SimpleAsyncGameActivity {
	...
	public EngineOptions onCreateEngineOptions() {
		...
		return new EngineOptions(true, ScreenOrientation.LANDSCAPE_FIXED, new RatioResolutionPolicy(AsyncGameActivityExample.CAMERA_WIDTH, AsyncGameActivityExample.CAMERA_HEIGHT), camera);
	}
