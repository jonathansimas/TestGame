...
public class HullAlgorithmExample extends SimpleBaseGameActivity implements OnClickListener, IOnSceneTouchListener {
	...
	private void buildMeshAndHull() {
		...
		this.mMesh = new Mesh(centerX, centerY, this.mMeshVertices, this.mMeshVertexCount, org.andengine.entity.primitive.DrawMode.LINE_LOOP, this.getVertexBufferObjectManager(), DrawType.STATIC);
		...
		this.mHull = new Mesh(centerX, centerY, this.mHullVertices, this.mHullVertexCount, org.andengine.entity.primitive.DrawMode.LINE_LOOP, this.getVertexBufferObjectManager(), DrawType.STATIC);
