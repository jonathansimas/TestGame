...
public enum ExampleGroup {
	...
	TEXT(R.string.examplegroup_text,
			Example.TEXT, Example.TICKERTEXT, Example.CHANGEABLETEXT, Example.CUSTOMFONT, Example.STROKEFONT, Example.BITMAPFONT),
	AUDIO(R.string.examplegroup_audio, 
			Example.SOUND, Example.MUSIC),
	ADVANCED(R.string.examplegroup_advanced, 
			 Example.BOUNDCAMERA, Example.HULLALGORITHM), // Example.AUGMENTEDREALITY, Example.AUGMENTEDREALITYHORIZON),
	...
	OTHER(R.string.examplegroup_other, 
			Example.SCREENCAPTURE, Example.PAUSE, Example.MENU, Example.SUBMENU, Example.TEXTMENU, Example.ZOOM , Example.IMAGEFORMATS,   Example.ETC1TEXTURE, Example.TEXTUREOPTIONS, Example.CANVASTEXTURECOMPOSITING,  Example.COLORKEYTEXTURESOURCEDECORATOR, Example.LOADTEXTURE, Example.UPDATETEXTURE, Example.UNLOADRESOURCES, Example.RUNNABLEPOOLUPDATEHANDLER,  Example.LEVELLOADER),
